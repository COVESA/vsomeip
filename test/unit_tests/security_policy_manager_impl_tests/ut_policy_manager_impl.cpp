...
// Length deserialized by deserialize_id_item for instances. (Represent either 2*uint16_t = 4 bytes,
// or uint16_t = 2 bytes)
...
// Length deserialized by deserialize_id_item for second instance. (represent either 2*uint16_t = 4,
// or uint16 = 2)
...
TEST(security_policy_manager_test, load) {
    ...
    // is_audit returns !check_credentials_ which is by default false, so is_audit should return
    // true.
    ...
    // Check that is_audit now returns false. Since check_credentials should now be true if the load
    // worked.
...
TEST(security_policy_manager_test, check_credentials) {
    ...
    // Default test structure, case will fall through the logic checks to the end of the test
    // method.
    ...
    vsomeip_v3::byte_t byte_array_[array_size]{uid_byte1,
                                               uid_byte2,
                                               uid_byte3,
                                               uid_byte4,
                                               gid_byte1,
                                               ...
                                               gid_byte3,
                                               gid_byte4,
                                               request_length_byte1,
                                               request_length_byte2,
                                               request_length_byte3,
                                               request_length_byte4,
                                               request_service_byte1,
                                               request_service_byte2,
                                               id_array_length_byte1,
                                               id_array_length_byte2,
                                               id_array_length_byte3,
                                               id_array_length_byte4,
                                               request_instance_idlist_byte1,
                                               request_instance_idlist_byte2,
                                               request_instance_idlist_byte3,
                                               request_instance_idlist_byte4,
                                               instance_id_length_byte1,
                                               instance_id_length_byte2,
                                               instance_id_length_byte3,
                                               instance_id_length_byte4,
                                               instance_id_type_byte1,
                                               instance_id_type_byte2,
                                               instance_id_type_byte3,
                                               instance_id_type_byte4,
                                               instance_id_low_byte1,
                                               instance_id_low_byte2,
                                               instance_id_high_byte1,
                                               instance_id_high_byte2,
                                               request_method_idlist_byte1,
                                               request_method_idlist_byte2,
                                               request_method_idlist_byte3,
                                               request_method_idlist_byte4,
                                               method_id_length_byte1,
                                               method_id_length_byte2,
                                               method_id_length_byte3,
                                               method_id_length_byte4,
                                               method_id_type_byte1,
                                               method_id_type_byte2,
                                               method_id_type_byte3,
                                               method_id_type_byte4,
                                               method_id_low_byte1,
                                               method_id_low_byte2,
                                               method_id_high_byte1,
                                               method_id_high_byte2,
                                               offer_length_byte1,
                                               offer_length_byte2,
                                               offer_length_byte3,
                                               offer_length_byte4,
                                               ...
                                               offer_instance_idlist_byte3,
                                               offer_instance_idlist_byte4,
                                               instance_id_length_byte1,
                                               instance_id_length_byte2,
                                               instance_id_length_byte3,
                                               instance_id_length_byte4,
                                               ...
                                               instance_id_high_byte1,
                                               instance_id_high_byte2,
                                               instance2_id_length_byte1,
                                               instance2_id_length_byte2,
                                               instance2_id_length_byte3,
                                               instance2_id_length_byte4,
                                               instance2_id_type_byte1,
                                               instance2_id_type_byte2,
                                               instance2_id_type_byte3,
                                               instance2_id_type_byte4,
    ...
    // Load policy element, which should set check_credentials to true. Needed to differentiate
    // returns test cases (sets the default test to false).
    its_policy_manager->load(its_element, lazy_load);
    ...
    // Test Method, expect call to default through and return !check_credentials. Since we set it to
    // true we expect false.
...
TEST(security_policy_manager_test, check_routing_credentials) {
    ...
    // Create a policy element setting check_credentials to true. And check_routing_credentials to
    // true.
    const std::string element_name = "random";
    boost::property_tree::ptree tree;
    boost::property_tree::ptree tree_security;
    ...
    // Test Method, expect call to return true. This method, defaults even with nullptr, no null
    // checks.
    ASSERT_TRUE(its_policy_manager->check_routing_credentials(nullptr));

    // Load policy element not lazy load, to call load_routing_credentials which should set
    // check_routing_credentials_ to true.
    its_policy_manager->load(its_element, not_lazy_load);

    // Test Method, expect call to default through and return !check_routing_credentials. Since we
    // set it to true we expect false.
...
TEST(security_policy_manager_test, set_routing_credentials) {
    ...
    // Test Method, expect call to default through and return !check_routing_credentials. Since it
    // is false by default, we expect true.
...
TEST(security_policy_manager_test, get_requester_policies) {
    ...
    // Expect true because of the continue in the for loops if its_policy is equal to the policy in
    // the manager.
    ASSERT_TRUE(its_policy_set.empty());
...
TEST(security_policy_manager_test, get_policy_extension_path) {
    ...
    // Load policy element, which should should add the container and its path to
    // policy_extension_paths_.
    its_policy_manager->load(its_element, not_lazy_load);
...
TEST(security_policy_manager_test, is_policy_removal_allowed) {
    ...
    // Test method. Expect true because it will return the default option !check_whitelist_ which is
    // false.
    ...
    // Test method. Expect true. Since we set up an interval, if uid is between 0 and max uint32_t
    // we should get true.
    ASSERT_TRUE(its_policy_manager->is_policy_removal_allowed(uid));
}
...
TEST(security_policy_manager_test, is_policy_update_allowed) {
    ...
    // Set any interval for uid and services so we should get true if the uid is contained within
    // the min and max.
    tree_whitelists_any_interval.put_value("any");
    tree_security_update_whitelist.add_child("uids", tree_whitelists_any_interval);
    tree_whitelists_any_interval.put_value("any");
...
TEST(security_policy_manager_test, is_policy_extension_loaded) {
    ...
    // Test method. Expect an inexistent return because the set_is_plocity_extension_loaded method
    // hasn't be called.
    ASSERT_EQ(its_policy_manager->is_policy_extension_loaded(client_name),
              vsomeip_v3::policy_manager_impl::policy_loaded_e::POLICY_PATH_INEXISTENT);
    ...
    // Test method. Since we used true for loaded in the set method we expect found and loaded
    // return.
    ASSERT_EQ(its_policy_manager->is_policy_extension_loaded(client_name),
