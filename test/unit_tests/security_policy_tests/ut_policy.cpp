...
TEST(security_policy_test, deserialize) {
    ...
    std::array<vsomeip_v3::byte_t, array_size> byte_array_{uid_byte1,
                                                           uid_byte2,
                                                           uid_byte3,
                                                           uid_byte4,
                                                           gid_byte1,
    ...
    auto deserialized_gid_set = its_policy->credentials_.lower_bound(boost::icl::interval<vsomeip_v3::uid_t>::closed(uid, uid));
    ...
    auto deserialized_service_set =
            its_policy->requests_.lower_bound(boost::icl::interval<vsomeip_v3::service_t>::closed(request_service, request_service));
    ...
    // Check if method high and low were deserialized correctly by private method deserialize_u16
    auto deserialized_offer_service_set =
            its_policy->offers_.lower_bound(boost::icl::interval<vsomeip_v3::instance_t>::closed(offer_service, offer_service));
    ...
    // Note if the second interval falls within the first one or vise versa, since we are using an
    // interval set, it will only have 1 item.
...
TEST(security_policy_test, serialize) {
    ...
    std::array<vsomeip_v3::byte_t, resized_array_size> byte_array_{
            ...
            // offer_instance_idlist_byte1, offer_instance_idlist_byte2,
            // offer_instance_idlist_byte3, offer_instance_idlist_byte4, instance_id_length_byte1,
            // instance_id_length_byte2, instance_id_length_byte3, instance_id_length_byte4,
            // instance_id_type_byte1, instance_id_type_byte2, instance_id_type_byte3,
            // instance_id_type_byte4, instance_id_low_byte1, instance_id_low_byte2,
            // instance_id_high_byte1, instance_id_high_byte2,
            // instance2_id_length_byte1, instance2_id_length_byte2, instance2_id_length_byte3,
            // instance2_id_length_byte4, instance2_id_type_byte1, instance2_id_type_byte2,
            // instance2_id_type_byte3, instance2_id_type_byte4, instance2_id_low_byte1,
            // instance2_id_low_byte2
    };
