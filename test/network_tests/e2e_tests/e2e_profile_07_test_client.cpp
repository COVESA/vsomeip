...
void e2e_profile_07_test_client::on_message(const std::shared_ptr<vsomeip::message>& _message) {
    ...
    if (vsomeip::message_type_e::MT_RESPONSE == _message->get_message_type() && PROFILE_07_METHOD == _message->get_method()) {
        ...
        VSOMEIP_INFO << "Event 0x" << std::hex << std::setfill('0') << std::setw(4) << PROFILE_07_EVENT
                     << " -> IS_VALID_CRC = " << std::boolalpha << _message->is_valid_crc();
        EXPECT_EQ(true, _message->is_valid_crc());
...
int main(int argc, char** argv) {
    ...
    responses_ = {{0xf7, 0xa1, 0x9e, 0x0e, 0x9d, 0xbd, 0xa7, 0xca, 0x00, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                  ...
                  {0xca, 0xb7, 0xae, 0x78, 0xe2, 0xa5, 0xdc, 0xab, 0x00, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
                  ...
                  {0xbe, 0x5c, 0xe8, 0xd0, 0xa8, 0x3a, 0xca, 0x41, 0x00, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
