...
void e2e_profile_04_test_client::on_message(const std::shared_ptr<vsomeip::message>& _message) {
    ...
    if (vsomeip::message_type_e::MT_RESPONSE == _message->get_message_type() && PROFILE_04_METHOD == _message->get_method()) {
        ...
        VSOMEIP_INFO << "Method ID 0x" << std::hex << std::setfill('0') << std::setw(4) << PROFILE_04_METHOD
        ...
        VSOMEIP_INFO << __func__ << ": Event 0x" << std::hex << std::setfill('0') << std::setw(4) << PROFILE_04_EVENTGROUP
                     << " -> IS_VALID_CRC = " << std::boolalpha << _message->is_valid_crc();
        EXPECT_EQ(true, _message->is_valid_crc());
...
int main(int argc, char** argv) {
    ...
    responses_ = {{0x00, 0x50, 0x00, 0x00, 0x01, 0x00, 0x00, 0x2d, 0xaa, 0x1d, 0x3f, 0xdf, 0x08, 0xb7, 0xf4, 0x4c, 0x00, 0x00,
                   0x09, 0x3d, 0x00, 0x01, 0x06, 0xfe, 0x01, 0x3e, 0x4c, 0xcc, 0xcd, 0x80, 0x3f, 0xb2, 0x3d, 0x83, 0x3e, 0xba,
                  ...
                  {0x00, 0x50, 0x00, 0x01, 0x01, 0x00, 0x00, 0x2d, 0xe7, 0xb7, 0x13, 0x87, 0x0c, 0x69, 0x02, 0x1c, 0x00, 0x00,
                  ...
                  {0x00, 0x50, 0x00, 0x02, 0x01, 0x00, 0x00, 0x2d, 0xb6, 0x19, 0x94, 0x2c, 0x10, 0x1b, 0x28, 0xae, 0x00, 0x00,
    ...
    events_ = {{0x00, 0x50, 0x8f, 0x81, 0x01, 0x00, 0x00, 0x2d, 0xed, 0x6e, 0x78, 0x8d, 0x08, 0xb7, 0xf4, 0x4c, 0x00, 0x00,
                0x09, 0x3d, 0x00, 0x01, 0x06, 0xfe, 0x01, 0x3e, 0x4c, 0xcc, 0xcd, 0x80, 0x3f, 0xb2, 0x3d, 0x83, 0x3e, 0xba,
                0x68, 0xed, 0x3f, 0xb3, 0x7a, 0xf2, 0xbd, 0x96, 0xc1, 0x42, 0x3d, 0x25, 0x1a, 0x62, 0xbd, 0xae, 0x77, 0xf3,
                0x3f, 0x80, 0x00, 0x00, 0xfc, 0x01, 0x01, 0x3c, 0x1d, 0xbd, 0x4e, 0x01, 0x01, 0x3c, 0x2b, 0x87, 0xed, 0x00},
               {0x00, 0x50, 0x8f, 0x82, 0x01, 0x00, 0x00, 0x2d, 0x9d, 0xbb, 0x49, 0x3f, 0x0c, 0x69, 0x02, 0x1c, 0x00, 0x00,
                0x09, 0x3d, 0x00, 0x01, 0x06, 0xfe, 0x01, 0x3e, 0x4c, 0xcc, 0xcd, 0x80, 0x3f, 0xb2, 0x3c, 0x2f, 0x3e, 0xba,
                0x46, 0x81, 0x3f, 0xb3, 0x73, 0x8d, 0xbd, 0x93, 0xcb, 0xae, 0x3c, 0xf7, 0xd2, 0x58, 0xbd, 0xa2, 0x6e, 0xcd,
                0x3f, 0x80, 0x00, 0x00, 0xfc, 0x01, 0x01, 0x3c, 0x1c, 0x89, 0x24, 0x01, 0x01, 0x3c, 0x2b, 0x24, 0x45, 0x00},
               {0x00, 0x50, 0x8f, 0x83, 0x01, 0x00, 0x00, 0x2d, 0x13, 0x04, 0xf8, 0x81, 0x10, 0x1b, 0x28, 0xae, 0x00, 0x00,
                0x09, 0x3d, 0x00, 0x01, 0x06, 0xfe, 0x01, 0x3e, 0x4c, 0xcc, 0xcd, 0x80, 0x3f, 0xb2, 0x3e, 0xf3, 0x3e, 0xba,
                0x97, 0x45, 0x3f, 0xb3, 0x86, 0x81, 0xbd, 0x8a, 0xda, 0xc2, 0x3c, 0xf6, 0x00, 0x7a, 0xbd, 0xb4, 0xf9, 0xb9,
                0x3f, 0x80, 0x00, 0x00, 0xfc, 0x01, 0x01, 0x3c, 0x1c, 0x1b, 0x72, 0x01, 0x01, 0x3c, 0x2a, 0x9e, 0x1f, 0x00}};
