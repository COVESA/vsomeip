...
bool lazy_load_test_service::init() {
    ...
    app_->register_message_handler(vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
                                   ...
                                   std::bind(&lazy_load_test_service::on_message, this, std::placeholders::_1));

    app_->register_message_handler(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, vsomeip_test::TEST_SERVICE_METHOD_ID_SHUTDOWN,
                                   std::bind(&lazy_load_test_service::on_message_shutdown, this, std::placeholders::_1));

    app_->register_message_handler(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, vsomeip_test::TEST_SERVICE_METHOD_ID,
                                   std::bind(&lazy_load_test_service::on_message, this, std::placeholders::_1));

    app_->register_state_handler(std::bind(&lazy_load_test_service::on_state, this, std::placeholders::_1));
    ...
    app_->offer_event(vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
                      static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_DEFAULT), its_eventgroups, vsomeip::event_type_e::ET_FIELD,
    ...
    app_->offer_event(vsomeip_test::TEST_SERVICE_SERVICE_ID, vsomeip_test::TEST_SERVICE_INSTANCE_ID,
                      static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_LAZY), its_eventgroups, vsomeip::event_type_e::ET_FIELD,
                      std::chrono::milliseconds::zero(), false, true, nullptr, vsomeip::reliability_type_e::RT_UNRELIABLE);

    // Used with lazy client also offer field 0x8001 which is not allowed to be received by lazy
    // client
    app_->offer_event(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_DEFAULT),
                      its_eventgroups, vsomeip::event_type_e::ET_FIELD, std::chrono::milliseconds::zero(), false, true, nullptr,
                      vsomeip::reliability_type_e::RT_UNRELIABLE);

    app_->offer_event(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_LAZY),
                      its_eventgroups, vsomeip::event_type_e::ET_FIELD, std::chrono::milliseconds::zero(), false, true, nullptr,
                      vsomeip::reliability_type_e::RT_UNRELIABLE);
    ...
    app_->notify(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_DEFAULT),
                 its_payload);

    app_->notify(vsomeip_test::TEST_SERVICE_SERVICE_ID, TEST_INSTANCE_LAZY, static_cast<vsomeip::event_t>(EVENT_TO_ACCEPT_LAZY),
                 its_payload);
...
void lazy_load_test_service::on_message_shutdown(const std::shared_ptr<vsomeip::message>&) {
