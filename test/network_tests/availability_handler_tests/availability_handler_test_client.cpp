...
public:
    availability_handler_test_client() :
        vsomeip_utilities::base_logger("AHTC", "AVAILABILITY HANDLER TEST CLIENT") {
    ...
    void run() {
        ...
        ASSERT_NO_THROW({
...

            {
                ...
                local_client_cv_.wait(local_lock, [&]() {
...
private:
    ...
    void init() {
        ...
        app_->register_state_handler(
                std::bind(&availability_handler_test_client::on_state, this, std::placeholders::_1));

        app_->register_availability_handler(
                SERVICE_ID, INSTANCE_ID,
                std::bind(&availability_handler_test_client::on_availability, this,
    ...
    void register_availability_handler() {
        ...
        availability_handler_shared_->reregister_status_ =
                availability_handler::availability_handler_test_steps::REREGISTER_NOT_DONE;
    ...
    void on_availability(vsomeip::service_t _service, vsomeip::instance_t _instance,
        ...
        VSOMEIP_INFO << "Service [" << std::hex << std::setfill('0') << std::setw(4) << _service
                     << "." << _instance << "] is "
    ...
    void send_requests() {
        ...
        availability_handler_shared_->request_status_ =
                availability_handler::availability_handler_test_steps::REQUESTS_NOT_SENT;
