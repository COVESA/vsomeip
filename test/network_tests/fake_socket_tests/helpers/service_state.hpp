...
struct event_subscription {
    ...
    [[nodiscard]] bool operator==(event_subscription const& rhs) const {
        return ei_ == rhs.ei_ && error_code_ == rhs.error_code_;
    }
...
struct client_session {
    ...
    [[nodiscard]] bool operator==(client_session const& rhs) const {
        return client_ == rhs.client_ && session_ == rhs.session_;
    }
...
struct request {
    ...
    [[nodiscard]] bool operator==(request const& rhs) const {
        auto tie = [](auto const& d) {
            return std::tie(d.service_instance_, d.method_, d.message_type_, d.payload_);
        };
...
struct message {
    ...
    [[nodiscard]] bool operator==(message const& rhs) const {
        auto tie = [](auto const& d) {
            return std::tie(d.client_session_, d.service_instance_, d.method_, d.message_type_,
                            d.payload_);
        };
        return tie(*this) == tie(rhs);
    }
