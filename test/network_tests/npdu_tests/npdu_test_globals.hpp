...
constexpr std::array<vsomeip::service_t, 4> service_ids = {0x1000, 0x2000, 0x3000, 0x4000};
constexpr std::array<vsomeip::instance_t, 4> instance_ids = {service_ids[0] >> 12, service_ids[1] >> 12, service_ids[2] >> 12,
                                                             service_ids[3] >> 12};
...
constexpr std::array<vsomeip::client_t, 4> client_ids_clients = {0x1111, 0x2222, 0x3333, 0x4444};
