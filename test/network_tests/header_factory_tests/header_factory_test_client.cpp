...
header_factory_test_client::header_factory_test_client(bool _use_tcp) :
    ...
    number_of_acknowledged_messages_(0), sender_(std::bind(&header_factory_test_client::run, this)) { }
...
bool header_factory_test_client::init() {
    ...
    app_->register_state_handler(std::bind(&header_factory_test_client::on_state, this, std::placeholders::_1));
