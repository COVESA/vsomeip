...
VSOMEIP_PLUGIN(vsomeip::e2e::e2e_provider_impl)
...
bool e2e_provider_impl::is_protected(e2exf::data_identifier id) const
{
    return custom_protectors.count(id) > 0;
}

bool e2e_provider_impl::is_checked(e2exf::data_identifier id) const
{
    return custom_checkers.count(id) > 0;
}

void e2e_provider_impl::protect(e2exf::data_identifier id, e2e_buffer &_buffer)
{
...
void e2e_provider_impl::check(e2exf::data_identifier id, const e2e_buffer &_buffer,
...
e2e_provider_impl::make_e2e_profile_config(std::shared_ptr<vsomeip::cfg::e2e> config) {
