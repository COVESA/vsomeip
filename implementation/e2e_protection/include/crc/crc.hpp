...
class e2e_crc {
public:
    static uint8_t calculate_profile_01(buffer_view _buffer_view, const uint8_t _start_value = 0x00U);
    static uint32_t calculate_profile_04(buffer_view _buffer_view, const uint32_t _start_value = 0x00000000U);
    static uint16_t calculate_profile_05(buffer_view _buffer_view, const uint16_t _start_value = 0xFFFFU);
    static uint64_t calculate_profile_07(buffer_view _buffer_view, const uint64_t _start_value = 0x0000000000000000U);
