...
configuration_impl::configuration_impl(const std::string& _path) :
    ...
    diagnosis_mask_{0xFF00}, has_console_log_{true}, has_file_log_{false}, has_dlt_log_{false},
    has_cross_vlan_multicast_{false}, multicast_ttl_{VSOMEIP_MULTICAST_DEFAULT_TTL},
    logfile_{"/tmp/vsomeip.log"},loglevel_{vsomeip_v3::logger::level_e::LL_INFO}, is_sd_enabled_{VSOMEIP_SD_DEFAULT_ENABLED}, sd_protocol_{VSOMEIP_SD_DEFAULT_PROTOCOL},
...
configuration_impl::configuration_impl(const configuration_impl& _other) :
    ...
    has_file_log_{_other.has_file_log_.load()}, has_dlt_log_{_other.has_dlt_log_.load()},has_cross_vlan_multicast_{_other.has_cross_vlan_multicast_.load()},
