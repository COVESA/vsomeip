...
void tcp_client_impl::connect() {
	socket_.async_connect(local_,
				boost::bind(&tcp_client_base_impl::connect_cbk, this,
					boost::asio::placeholders::error));
}

void tcp_client_impl::receive() {
	socket_.async_receive(boost::asio::buffer(buffer_),
				boost::bind(&tcp_client_base_impl::receive_cbk, this,
					boost::asio::placeholders::error,
...
void tcp_client_impl::send_queued() {
	...
	boost::asio::async_write(socket_,
			...
			boost::bind(&tcp_client_base_impl::send_cbk, this,
						boost::asio::placeholders::error,
						boost::asio::placeholders::bytes_transferred));
}
