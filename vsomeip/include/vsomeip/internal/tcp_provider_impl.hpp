...
#ifndef VSOMEIP_INTERNAL_TCP_PROVIDER_IMPL_HPP
#define VSOMEIP_INTERNAL_TCP_PROVIDER_IMPL_HPP
...
class tcp_provider_impl
		: virtual public provider_base_impl {
public:
	tcp_provider_impl(
			factory *_factory,
			const endpoint *_endpoint,
			boost::asio::io_service &_is);
	virtual ~tcp_provider_impl();
...
private:
	...
	public:
		...
		static pointer create(tcp_provider_impl *_owner);
	...
	private:
		connection(tcp_provider_impl *_service);
...
#endif // VSOMEIP_INTERNAL_TCP_PROVIDER_IMPL_HPP
