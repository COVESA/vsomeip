...
sudo ip route add default via 192.168.20.1 dev enp0s3.20 2>/dev/null || true
...
sudo ping -c 4 192.168.20.1
echo "Ping the client:"
sudo ping -c 4 192.168.10.2
